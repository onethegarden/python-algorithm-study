...
def solution(L, x, l, u):
  print(l, u)
  if l > u: # solution([1,2,3,4], 4, 0, 3) 케이스로 생각해 봤을 때 마지막에 l과 u가 같아지는 순간도 비교를 해야 하므로 l>u가 맞음
    return -1
  mid = (l + u) // 2
  if x == L[mid]:
    return mid
...
l = 0
u = 6
print(f"{x}의 위치는 : {solution(L, x, l, u)}")
L = [2, 5, 7, 9, 11]
x = 4
l = 0
u = 4
...
print(f"6의 위치는 : {solution([2, 4, 5], 6, 0, 2)}")
print(f"4의 위치는 : {solution([1,2,3,4], 4, 0, 3)}")
